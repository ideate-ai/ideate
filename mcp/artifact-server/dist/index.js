...
import { createDormantState, initServer, routeToolCall } from "./server.js";
...
// ---------------------------------------------------------------------------
const server = new Server({ name: "ideate-artifact-server", version: pkg.version }, { capabilities: { tools: {} } });
