...
function resolveEntropyThreshold(raw) {
    if (raw === undefined)
        return DEFAULT_ENTROPY_THRESHOLD;
    if (typeof raw !== 'number' || !Number.isFinite(raw)) {
        throw new RangeError(`scanAndMask: entropyThreshold must be a finite number, got ${String(raw)}`);
    }
    return raw;
}
/**
 ...
 */
export function scanAndMask(content, options) {
