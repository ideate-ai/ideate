 ...
 */
export const toolRegistrars = [createRecordToolsRegistrar()];
/** Apply each registrar in `registrars` (default: the composed root) to `server`, in order. */
export function registerTools(server, registrars = toolRegistrars) {
 ...
 */
export function createServer(registrars = toolRegistrars) {
