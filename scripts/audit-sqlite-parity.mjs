...
const EXTENSION_FIELDS = {
  ...
  metrics_events: ["event_name", "timestamp", "payload", "input_tokens", "output_tokens", "cache_read_tokens", "cache_write_tokens", "outcome", "finding_count", "finding_severities", "first_pass_accepted", "rework_count", "work_item_total_tokens", "cycle_total_tokens", "cycle_total_cost_estimate", "convergence_cycles", "context_artifact_ids"],
