...
- [ ] Activate PR-002 project
- [ ] Run `/ideate:execute` for PH-019 (WI-551 through WI-556)
  - [ ] WI-551: Define StorageAdapter TypeScript interface
  - [ ] WI-552: LocalAdapter — write operations
  - [ ] WI-553: LocalAdapter — read and query operations
  - [ ] WI-554: LocalAdapter — context assembly and PPR
  - [ ] WI-555: Adapter-level contract tests
  - [ ] WI-556: Config extension for backend selection
...
- [ ] Build migration CLI (in ideate-server)
- [ ] Import `ideate/.ideate/` into local Neo4j
- [ ] Import `ideate-server/.ideate/` into same Neo4j
- [ ] Verify dogfood acceptance criteria (`migration-tool-spec.md` Section 15)
- [ ] Implement RemoteAdapter in ideate MCP server (PR-002 Phase 2)
...
- **Phase**: PH-019 (StorageAdapter Extraction) — planned, not yet started
